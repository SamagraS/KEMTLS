...
export const THREATS: ThreatInfo[] = [
  ...
  },
  {
    ...
    mitigation: 'Session binding (cnf.kbh = SHA256(tls-exporter || session_id)) cryptographically ties tokens to this specific TLS channel.',
    severity: 'high',
    icon: '🔗',
  },
  {
    ...
    mitigation: 'Proof-of-Possession (PoP) via ML-DSA-65 proves the presenter holds the private key bound to this session.',
    severity: 'medium',
    icon: '🛡️',
  },
];
